...
export default function Hero() {
    ...
    return (
        <section id="home" className="min-h-screen flex items-center pt-20 relative overflow-hidden">
            {/* Background blobs */}
            <div className="absolute top-1/4 right-0 w-[500px] h-[500px] bg-cyan-500/20 rounded-full blur-[100px] -z-10 animate-pulse" />
            <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-blue-600/20 rounded-full blur-[100px] -z-10" />
            ...
            <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
                ...
                >
                    ...
                    <div className="flex flex-wrap gap-4">
                        <a
                            href="#contact"
                            className="group px-8 py-3 bg-white text-slate-900 font-semibold rounded-full hover:bg-cyan-50 transition-all flex items-center gap-2"
                        >
                            {t.hero.ctaPrimary}
                        ...
                        <a
                            href="#projects"
                            className="px-8 py-3 bg-slate-800/50 border border-white/10 text-white font-medium rounded-full hover:bg-slate-800 transition-all backdrop-blur-sm"
                        >
                            {t.hero.ctaSecondary}
                        </a>
                    </div>
                ...
                >
                    <div className="relative w-80 h-80 md:w-[450px] md:h-[450px]">
                        ...
                        <div className="absolute inset-6 rounded-full overflow-hidden border-4 border-slate-800/80 shadow-2xl shadow-cyan-500/20 z-10">
                            <Image
